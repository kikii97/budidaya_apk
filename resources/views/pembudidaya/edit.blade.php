            ...
            <form action="{{ route('pembudidaya.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label>Nama</label>
                        <input type="text" name="name" value="{{ old('name', $pembudidaya->name) }}"
                            class="form-control" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Nomor Telepon</label>
                        <input type="text" name="nomor_telepon"
                            value="{{ old('nomor_telepon', optional($pembudidaya->profil)->nomor_telepon) }}"
                            class="form-control">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="mb-3">
                    ...
                    @if ($pembudidaya->profil && $pembudidaya->profil->foto_profil)
                        ...
                        <img src="{{ asset('storage/' . $pembudidaya->profil->foto_profil) }}"
                            alt="Foto Profil" width="100" class="mb-2">
