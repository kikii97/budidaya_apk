...
<body class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="card p-4 shadow-lg border-0" style="width: 380px;">
        <div class="card-body">
            ...
            <form action="{{ route('pembudidaya.register.post') }}" method="POST">
                @csrf
                <div class="mb-3">
            ...
            <p class="text-center mt-3">Sudah punya akun? <a href="{{ route('pembudidaya.login') }}" class="text-decoration-none text-success fw-bold">Masuk</a></p>
        </div>
    </div>
