            ...
            <div class="col-lg-9">
                <div class="row g-4">
                        ...
                        <a href="{{ url('detail') }}">
                            <div class="product-card shadow-sm">
                                <div class="position-relative">
                                    <img src="apk_gis/public/images/udang.jpg" class="product-image w-100"
                                        alt="Product">
                    ...
                    <div class="col-md-4">
                        <div class="product-card shadow-sm">
                            <div class="position-relative">
                                <img src="apk_gis/public/images/rumputlaut.jpg" class="product-image w-100"
                                    alt="Product">
                                <button class="wishlist-btn">
                                    <i class="bi bi-heart"></i>
                                </button>
                    ...
                    <div class="col-md-4">
                        <div class="product-card shadow-sm">
                            <div class="position-relative">
                                <img src="apk_gis/public/images/ikannila.jpeg" class="product-image w-100"
                                    alt="Product">
