...
@if (session('success'))
    <div id="popupAlert"
        ...
        role="alert" style="z-index: 1050; width: fit-content; max-width: 90%;">
        {{ session('success') }}
...
<section style="padding-top: 0px;">
    <div class="container py-2" style="padding-top: 0rem !important;">
        <div class="row d-flex justify-content-center" style="zoom: 80%;">
            <div class="col">
                ...
                <div class="rounded-top text-white d-flex flex-wrap align-items-center justify-content-between p-3">
                    ...
                    @if ($isOwner)
                        <div class="d-flex gap-2 mt-2 mt-md-0">
                            ...
                            @else
                                <a href="{{ route('pembudidaya.dokumen.create') }}"
                ...
                <div class="mt-0 p-4 text-black mb-3" style="font-size: 80%;">
                    ...
                    <div class="d-flex flex-row gap-3">
                        <div class="flex-grow-1">
                            <div
                                class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-2 gap-2 text-body">
                                <p class="lead fw-normal mb-0">Produk Saya</p>
                                <form id="bulkDeleteForm"
                                    action="{{ route('pembudidaya.pembudidaya.produk.destroy.multiple') }}"
                                    method="POST"
                                    onsubmit="return confirm('Yakin ingin menghapus produk yang dipilih?');">
                                    @csrf
                                    @method('DELETE')
                                    @if ($isOwner && count($produk))
                                        <div class="d-flex align-items-center gap-2" style="line-height: 1;">
                                            <div class="d-flex align-items-center" style="gap: 6px;">
                                                ...
                                                <label for="selectAllCheckbox" class="form-check-label text-muted"
                                                    style="font-size: 13px;">Pilih Semua</label>
                                            </div>
