...
<head>
    ...
    <title>Daftar Pembudidaya</title>
...
<body class="h-full">
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900">Daftar Pembudidaya</h1>
                </div>
                <div class="relative w-32 sm:w-48 md:w-64 lg:w-80">
                    <input type="text" placeholder="Cari..." class="w-full border rounded-md px-3 py-1.5 text-gray-700 text-sm sm:text-base focus:ring-2 focus:ring-blue-500 focus:outline-none pr-10">
                    <button class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35m0 0A8.5 8.5 0 1011 19a8.5 8.5 0 005.65-2.35z" />
                        </svg>
                    </button>
                </div>
            </div>
        ...
        <main class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-center relative bg-gray-100">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h2 class="text-2xl sm:text-3xl font-bold text-black mb-6 relative inline-block">
                    Daftar Pembudidaya Rumput Laut di Kandanghaur
                    <div class="w-32 h-1 bg-gradient-to-r from-blue-500 to-green-500 mt-2 mx-auto rounded-full"></div>
                </h2>
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6">
                    
                    <!-- Card 1 -->
                    <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition transform hover:scale-105 p-2 sm:p-4">
                        <img src="/images/rumputlaut.jpg" alt="Rumput Laut" class="w-full h-32 sm:h-48 object-cover">
                        <div class="p-2 sm:p-4">
                            <h3 class="text-xs sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 line-clamp-2">Nama Pembudidaya 1</h3>
                            <p class="text-xs sm:text-sm text-gray-600 line-clamp-2">Alamat: Jl. Pantai No. 1, Kandanghaur</p>
                            <p class="text-xs sm:text-sm text-gray-600 line-clamp-2">Jenis Komoditas: Rumput Laut Kering</p>
                            <p class="text-xs sm:text-sm text-green-600 font-bold line-clamp-2">Kisaran Harga: Rp. 5.000 - Rp. 7.000 /kg</p>
                            <a href="/detail_pembudidaya" class="mt-1 sm:mt-4 inline-block bg-blue-600 text-white px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm rounded-lg hover:bg-blue-700 transition">
                                Lihat Detail
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition transform hover:scale-105 p-2 sm:p-4">
                        <img src="/images/rumputlaut.jpg" alt="Rumput Laut" class="w-full h-32 sm:h-48 object-cover">
                        <div class="p-2 sm:p-4">
                            <h3 class="text-xs sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 line-clamp-2">Nama Pembudidaya 2</h3>
                            <p class="text-xs sm:text-sm text-gray-600 line-clamp-2">Alamat: Jl. Laut No. 5, Kandanghaur</p>
                            <p class="text-xs sm:text-sm text-gray-600 line-clamp-2">Jenis Komoditas: Rumput Laut Segar</p>
                            <p class="text-xs sm:text-sm text-green-600 font-bold line-clamp-2">Kisaran Harga: Rp. 8.000 - Rp. 10.000 /kg</p>
                            <a href="/detail_pembudidaya" class="mt-1 sm:mt-4 inline-block bg-blue-600 text-white px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm rounded-lg hover:bg-blue-700 transition">
                                Lihat Detail
                            </a>
                        </div>
                    ...
                    <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition transform hover:scale-105 p-2 sm:p-4">
                        <img src="/images/rumputlaut.jpg" alt="Rumput Laut" class="w-full h-32 sm:h-48 object-cover">
                        <div class="p-2 sm:p-4">
                            <h3 class="text-xs sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 line-clamp-2">Nama Pembudidaya 3</h3>
                            <p class="text-xs sm:text-sm text-gray-600 line-clamp-2">Alamat: Jl. Nelayan No. 7, Kandanghaur</p>
                            <p class="text-xs sm:text-sm text-gray-600 line-clamp-2">Jenis Komoditas: Rumput Laut Kering</p>
                            <p class="text-xs sm:text-sm text-green-600 font-bold line-clamp-2">Kisaran Harga: Rp. 11.000 - Rp. 13.000 /kg</p>
                            <a href="/detail_pembudidaya" class="mt-1 sm:mt-4 inline-block bg-blue-600 text-white px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm rounded-lg hover:bg-blue-700 transition">
                                Lihat Detail
                            </a>
                        </div>
                    ...
                    <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition transform hover:scale-105 p-2 sm:p-4">
                        <img src="/images/rumputlaut.jpg" alt="Rumput Laut" class="w-full h-32 sm:h-48 object-cover">
                        <div class="p-2 sm:p-4">
                            <h3 class="text-xs sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 line-clamp-2">Nama Pembudidaya 4</h3>
                            <p class="text-xs sm:text-sm text-gray-600 line-clamp-2">Alamat: Jl. Raya No. 10, Kandanghaur</p>
                            <p class="text-xs sm:text-sm text-gray-600 line-clamp-2">Jenis Komoditas: Rumput Laut Basah</p>
                            <p class="text-xs sm:text-sm text-green-600 font-bold line-clamp-2">Kisaran Harga: Rp. 15.000 - Rp. 18.000 /kg</p>
                            <a href="/detail_pembudidaya" class="mt-1 sm:mt-4 inline-block bg-blue-600 text-white px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm rounded-lg hover:bg-blue-700 transition">
                                Lihat Detail
                            </a>
                        </div>
